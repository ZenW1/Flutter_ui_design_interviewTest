...
class TaskProgessWidget extends StatelessWidget {
  final Color color;
  const TaskProgessWidget({Key? key, required this.color}) : super(key: key);
  ...
  Widget _progressBar(){
    return Container(
      ...
      child: LinearProgressBar(
          ...
          backgroundColor: const Color.fromRGBO(133,105,106,1).withOpacity(0.5),
